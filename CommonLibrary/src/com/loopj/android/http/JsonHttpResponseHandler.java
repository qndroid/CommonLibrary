...
public class JsonHttpResponseHandler extends TextHttpResponseHandler
{
	 ...
	 * ����JSON�������ʱ����Ҫʵ�ֵ��Ǵ˷��������������onSuccess(),���ص��Ѿ���byte[]ת��Ϊ��JSONObject
	...
	{
		AsyncHttpClient.log.w(LOG_TAG,
				"onFailure(int, Header[], String, Throwable) was not overriden, but callback was received", throwable);
	}
