...
public class MySSLSocketFactory extends SSLSocketFactory
{
	...
	/**
	 * Returns a SSlSocketFactory which trusts only the .cert file 
	 * @return SSLSocketFactory
	 */
	public static SSLSocketFactory getFixedSocketFactory(InputStream cert)
	{
		SSLSocketFactory socketFactory;
		try
		{
			socketFactory = new MySSLSocketFactory(getKeystoreOfCA(cert));
		}
		catch (Throwable t)
		{
			t.printStackTrace();
