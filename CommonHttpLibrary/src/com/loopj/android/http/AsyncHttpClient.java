...
public class AsyncHttpClient
{
			...
			int httpsPort)
	{
		...
		schemeRegistry.register(new Scheme("https", sslSocketFactory, httpsPort)); // Ϊhttps�������SSLFactory
				...
				for (String header : clientHeaderMap.keySet())
				{
					if (request.containsHeader(header))
					{
						...
						log.d(LOG_TAG, String.format("Headers were overwritten! (%s | %s) overwrites (%s | %s)",
								header, clientHeaderMap.get(header), overwritten.getName(), overwritten.getValue()));
	 ...
	 *
	 * @param          the Android Context which initiated the request.
	 * @param url             the URL to send the request to.
	 * @param responseHandler the response handler instance that should handle the response.
	 * @return RequestHandle of future request process
	 */
